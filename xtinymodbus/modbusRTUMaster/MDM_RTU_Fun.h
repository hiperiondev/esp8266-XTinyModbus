...
MDError MDM_RTU_NB_RW(PModbus_RTU_CB pModbus_RTU_CB,ModbusFunCode funCode,uint8_t slaveAddr,uint16_t startAddr,uint16_t numOf,void *wData);
MDError MDM_RTU_RW(PModbus_RTU_CB pModbus_RTU_CB,ModbusFunCode funCode,uint8_t slaveAddr,uint16_t startAddr,uint16_t numOf,void *wData);
